...
if (isset($_POST['submit'])) {
  ...
  // if (empty($d) && empty($f) && empty($s) && empty($p) && empty($de) && empty($a) && empty($h)) {
    ...
    try {
      ...
      $q->bindParam(':desti', $d);
      $q->bindParam(':flight', $f);
      $q->bindParam(':seats', $s);
      $q->bindParam(':plan', $p);
      $q->bindParam(':dep', $de);

      $q->bindParam(':arrival', $a);
      $q->bindParam(':hotel', $h);
      $q->bindParam(':id', $id);
      $q->execute();
      ...
      // echo "<script>window.location.replace('/agency/trips')</script>";
...
<body>
  <header class="bg-white shadow border-b w-full">
    <div class="flex mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 space-x-4">
      <a href="/agency/trips" class="text-gray-800">
  ...
  <div class="container">
    <form id="contact" method="post" action="/agency/trips/edit-trip?tripId=<?php echo $id; ?>">
      ...
      <div class="row">
        <div class="col">
          ...
          <fieldset>
            <input type="text" name="desti" autocomplete="given-name" value="<?php echo $trip['Destination'] ?>">
          </fieldset>
          ...
          <fieldset>
            <input type="text" name="flight" autocomplete="street-address" value="<?php echo $trip['Flight_number'] ?>">
          </fieldset>
          <fieldset>
          ...
          <fieldset>
            <input type="text" name="seats" autocomplete="street-address"
              value="<?php echo $trip['Number_of_seats'] ?>">
          </fieldset>
        </div>
          ...
          <table>
            <tr>
              <fieldset>
                <td><label for="email">Plan
                  ...
                  <textarea id="text" name="plan" rows="6" cols="40" autocomplete="email"><?php echo $trip['Plan'] ?>
                  </textarea>
                </td>
              </fieldset>
            </tr>
            <tr>
              <fieldset>
                <td> <label for="last-name">Departure Date
                  ...
                  <input type="date" name="dep" autocomplete="family-name" id="co"
                    value="<?php echo $trip['Departure_date'] ?>">
                </td>
              </fieldset>
            </tr>
            <tr>
              ...
              <fieldset>
                <td> <label for="street-address">Arrival Date
                  ...
                  <input type="date" name="arrival" autocomplete="street-address" id="co"
                    value="<?php echo $trip['Arrival_date'] ?>">
                </td>
              </fieldset>
            </tr>
            ...
            <fieldset>
              <td><label for="city">Hotel
                ...
                <input type="text" name="hotel" autocomplete="address-level2" value="<?php echo $trip['Hotel'] ?>">
              </td>
            </fieldset>
          </table>
