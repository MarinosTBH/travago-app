    ...
    if (empty($_POST['username']) || empty($_POST['email']) || empty($_POST['password']) || empty($_POST['phone'])) {
        ...
        try {
            ...
            if ($row['num'] > 0) {
                ...
                $stmt = $pdo->prepare("INSERT INTO users (username, email, password, phone, user_type) 
...
<body>
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Create an agency account</h2>
        </div>

        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" action="/register/agency.php" method="post">
                <div>
                    <label for="username" class="block text-sm font-medium leading-6 text-gray-900">Agency name</label>
                    <div class="mt-2">
            ...
            <p class="mt-10 text-center text-sm text-gray-500">
                ...
                <a href="/login/index.php" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500"> Login</a>
            </p>
        </div>
    </div>
